...
# CONFIGURATION
# ==============================
openai.api_base = "GWDW_Link"
openai.api_key = os.getenv("GWDG_API_KEY", "key")

INPUT_DIR = Path("./label_article/final_label/combine_csv/gold_bertopic_fixed_categories_topk5.csv")
OUTPUT_DIR = Path("./label_article/final_label/gold_label")
...
def main():
    ...
    csv_files = [INPUT_DIR]
    print(f"Using input file: {INPUT_DIR}")
